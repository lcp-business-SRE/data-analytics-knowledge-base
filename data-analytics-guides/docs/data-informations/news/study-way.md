...
# 現代の観光データサイエンティストを定義する

われわれは、単なる研修計画ではなく、急成長する「観光DX（デジタルトランスフォーメーション）」市場への戦略的参入を目的としています。

単なる交通チケットサービスの提供者から、観光エコシステム全体にとって価値の高いデータおよびコンサルティングパートナーへと進化するためにコンサルタント人材育成のための、ロードマップを定義してみたいと思います。 [^1],[^2]

育成すべき人材像は、学術的なデータサイエンティストではなく、ビジネスに焦点を当てた **「観光データコンサルタント」** です。この人材になるためには必要な3つの核となる能力を統合したハイブリッドな知識が必要です。[^3]
